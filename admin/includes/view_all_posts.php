...
<table class="table table-bordered table-hover">
        ...
        <option value="delete">Verwijder</option>
         <option value="clone">Kopie</option>
        </select>
        </div> 
<div class="col-xs-4">
<input type="submit" name="submit" class="btn btn-success" value="Apply">
<a class="btn btn-primary" href="../posts.php?source=add_post">Nieuw bericht</a>
 </div>
                <thead>
                    <tr>
 ...
 <td><input class='checkBoxes' type='checkbox' name='checkBoxArray[]' value='<?php echo $post_id; ?>'></td>
        ...
        // echo "<td><a onClick=\"javascript: return confirm('Weet u zeker dat u wilt verwijderen'); \" href='posts.php?delete={$post_id}'>Delete</a></td>";
